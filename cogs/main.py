...
class main(commands.Cog):
    ...
    async def release(self, ctx:commands.Context):
        ...
        if 703063141990400001 not in [role.id for role in ctx.author.roles]:
            ...
            await ctx.send("Now sending the release tag in every minute and half minutes for a bit. I will let you know when I'm done.")
            await log.send(":warning::warning: **VALORANT will be __UNAVAILABLE__ until June 2nd due to preparations for the full release (June 2).:warning::warning:\nFor more information, please go to <#713451899092992031> or <#679877572431314981> for more information.\n\nAll modes of games have been disabled, and no one is currently able to play Valorant.\n\n:new::new: The time has been released, see the details in this tweet: http://twitter.com/PlayVALORANT/status/1267410566873669632\n\nTo get the exact countdown, see:\nAsia Servers: https://www.timeanddate.com/countdown/gaming?iso=20200602T08&p0=248&msg=Valorant+Asia&font=cursive&csz=1\nEurope Servers:https://www.timeanddate.com/countdown/gaming?iso=20200602T08&p0=37&msg=Valorant+Europe&font=cursive&csz=1\nNorth America Servers:\nhttps://www.timeanddate.com/countdown/gaming?iso=20200602T08&p0=179&msg=Valorant+North+America+%2F+Latin+America+%2F+South+America&font=cursive&csz=1\n\nWhen the game is released, ranking will not be available at first. Stay tuned for more announcements regarding it!**")
