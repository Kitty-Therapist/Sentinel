...
class main(commands.Cog):
    ...
    async def release(self, ctx:commands.Context):
        ...
        if 703063141990400001 not in [role.id for role in ctx.author.roles]:
            ...
            await log.send(":warning::warning: **VALORANT will be released on the 2nd of June, until then you will be unable to access the game. For more information, please go to <#713451899092992031>.** :warning::warning:")
