...
class main(commands.Cog):
    ...
    async def release(self, ctx:commands.Context):
        ...
        if 703063141990400001 not in [role.id for role in ctx.author.roles]:
            ...
            await ctx.send("Now sending the release tag in every five minutes for a hour. I will let you know when I'm done.")
            await log.send(":rotating_light: **VALORANT** is coming to everyone!! :rotating_light: Please read the following details regarding the full launch.\n\n- **Asia / OCE** servers are open now, but users may experience slowness due to the influx of players.\n\n- **Europe** servers are open now, but users may experience slowness due to the influx of players.\n\n- **North / South / Latin Americas** servers are opening at 8AM EDT, 7AM CDT, 6AM MDT, 5AM PDT, 4AM AKST, 2AM HST\n\n**Things to know:**\n- Please do not use VPN. We heavily discourage usage of VPNs as Riot's support currently don't support transfers as per <https://twitter.com/PlayVALORANT/status/1267614518684737536>.\n- Ranking / Competitive will not be available at this time. Stay tuned to <#679877572431314981> and social medias!\n- Having an error code? Head on over to <https://support-valorant.riotgames.com/hc/en-us/articles/360045619633-Error-Codes-in-VALORANT> to see what's going on!\n- Want to see patch notes? See here <https://beta.playvalorant.com/en-us/news/game-updates/valorant-patch-notes-1-0/>\n- Need to download the game? Download here <https://playvalorant.com/en-gb/download>\n- If you previously had Valorant Beta, you just need to update your client rather than downloading.")
            ...
            await log.send(":rotating_light: **VALORANT** is coming to everyone!! :rotating_light: Please read the following details regarding the full launch.\n\n- **Asia / OCE** servers are open now, but users may experience slowness due to the influx of players.\n\n- **Europe** servers are open now, but users may experience slowness due to the influx of players.\n\n- **North / South / Latin Americas** servers are opening at 8AM EDT, 7AM CDT, 6AM MDT, 5AM PDT, 4AM AKST, 2AM HST\n\n**Things to know:**\n- Please do not use VPN. We heavily discourage usage of VPNs as Riot's support currently don't support transfers as per <https://twitter.com/PlayVALORANT/status/1267614518684737536>.\n- Ranking / Competitive will not be available at this time. Stay tuned to <#679877572431314981> and social medias!\n- Having an error code? Head on over to <https://support-valorant.riotgames.com/hc/en-us/articles/360045619633-Error-Codes-in-VALORANT> to see what's going on!\n- Want to see patch notes? See here <https://beta.playvalorant.com/en-us/news/game-updates/valorant-patch-notes-1-0/>\n- Need to download the game? Download here <https://playvalorant.com/en-gb/download>\n- If you previously had Valorant Beta, you just need to update your client rather than downloading.")
            await asyncio.sleep(300)
            await ctx.send("I'm done sending the release tag for a while. Please run ``!vrelease`` if people are still asking.")
